...
<%@ page
	import="com.bootcampjava.electricityservice.models.fileprocessor.Customer,java.util.ArrayList"%>
		...
		<form action="FileProcessorServlet" method="POST"
			...
			<div class="col-3" style="margin-top: 50px">
				...
				<label class="btn btn-primary"> <span
					class="glyphicon glyphicon-folder-open" Style="margin-right: 10px"></span>Choose
					File <input type="file" name="inputfile" style="display: none;"
					required>
				</label>
		...
		<form action="DataCleanerServlet" method="post">
			<div class="col-3" style="margin-top: 20px">
				<button type="submit" class="btn btn-danger">
					Delete Data<span class="glyphicon glyphicon-trash"
						style="margin-left: 10px"></span>
				</button>
				<%
		if ("success".equals(request.getAttribute("status"))){ 
	%>
				<font color="green"><b>Done</b><span
					class="glyphicon glyphicon-thumbs-up"
					style="font-size: 20px; margin-left: 10px"></span></font>
				<% }%>
			</div>
		</form>
	</div>
